...
│ ↺ الرئيسي： \`${bot.owners?.[0]?.name || '𝐴𝐿𝐻𝑊𝐴𝑅𝑌'} (${bot.owners?.[0]?.jid?.split('@')[0] || 'لا يوجد'})\`
╰────────────────

⟡ ⵌ 𝐴𝐿𝐻𝑊𝐴𝑅𝑌 BOT SYSTEM ⵌ ⟡`;

  await conn.sendMessage(m.chat, {
    text: msg,
    contextInfo: context(m.sender, "https://i.top4top.io/p_3876oqwbm0.jpg")
